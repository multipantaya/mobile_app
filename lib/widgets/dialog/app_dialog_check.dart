            ...
            builder: (context, state) {
              return Column(
                children: [
                  ...
                  AutoSizeText(
                    AppLocalizations.of(context)!.selectedPaymentMethod.toUpperCase(),
                    textAlign: TextAlign.center,
                    style: AppTheme.textStyles.white16F700
                  ),
                  const SizedBox(height: 10),
                  ...AppLocalizations.of(context)!.paymentMethodText.split('*').map((e) => RadioButtonCustom(
                    value: e, 
                    groupValue: state.paymentSelected, 
                    title: e,
                    onChanged: (value) => context.read<CartCubit>().selectPaymentMethod(value!),
                  )),
                  const SizedBox(height: 10),
                  AutoSizeText(
                    widget.title,
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      AppButtonMini(
                        onPressed: aceptPolitics && aceptTerm && state.paymentSelected.isNotEmpty
